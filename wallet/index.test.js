...
describe('Wallet', () => {
  ...
  describe('creating a transaction', () => {
    ...
    describe('and doing the same transaction', () => {
      ...
      it('doubles the `sendAmount` subtracted from the wallet blance', () => {
  ...
  describe('calculating a balance', () => {
    ...
    it('calculates the balance for blockchain tranations matching the recipient', () =>{
      expect(wallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE + (addBalance * repeatAdd));
    });

    it('calculates the balance of the wallet after transactions', () => {
